...
int     main(void)
{
    ...
    // {
    //     std::getline(challenger_fstrm, challenger_ans);
    //     std::getline(master_fstrm, master_ans);

    //     if (master_ans.compare(challenger_ans) != 0)
    //     {
    //         std::cout << "ok\n";
    //     }
    //     else
    //     {
    //         std::cout << challenger_ans << std::endl;
    //         std::cout << master_ans << std::endl;
    //         std::cout << "failed\n";
    //     }
    // }
